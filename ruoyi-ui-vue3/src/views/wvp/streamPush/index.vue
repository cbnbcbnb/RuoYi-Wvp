    ...
    <el-table v-loading="loading" :data="pushList" border :row-key="(row)=> row.app + row.stream">
      ...
      <el-table-column label="操作" align="center" width="200" class-name="small-padding fixed-width" fixed="right">
        <template #default="scope">
          ...
          <!--          </el-button>-->
          <el-button link type="primary" @click="handleChannelConfiguration(scope.row)">
            通道配置
          </el-button>
          <el-button size="medium" icon="el-icon-position" type="text" @click="handleEdit(scope.row)">
            编辑
          </el-button>
          <el-button size="medium" icon="el-icon-delete" type="text" @click="handleDelete(scope.row.id)">
            删除
          </el-button>
...
import {addPush, listPush, updatePush} from "../../../api/wvp/push.js";
